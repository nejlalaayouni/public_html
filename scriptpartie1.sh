...
INSERT INTO client (nom, prenom) VALUES ('layouni', 'nejla'),('ali', 'ali'); show databases; show tables; SELECT * FROM client;" | mysql -u user1 -p -D bd_app -h 192.168.56.20 -P 3306 
...
<?php
\$bdd = new PDO('mysql:host=192.168.56.20;dbname=bd_app', 'user1', '123');
...
<?php
try{
$connection = new PDO('mysql:host=192.168.56.20;dbname=bd_app', 'user1', '123');
